...
Cost today: nothing — they were reference clones. THE FORWARD HAZARD IS THAT THE SAME
SILENCE IS TOTAL AND LOOKS IDENTICAL: if any leg ever clones into the scratchpad, its
entire repository is invisible to the snapshot mechanism WHILE THE SNAPSHOT REPORTS
SUCCESS. Day's dominant defect class — the signal exists and carries no information.
