...
// NewTestServerWithMultiStore creates a gRPC test server backed by a MultiStore.
// The caller can configure the MultiStore (e.g. register platform stores, set a
