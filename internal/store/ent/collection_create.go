...
func (_c *CollectionCreate) SetPlatform(v collection.Platform) *CollectionCreate {
	_c.mutation.SetPlatform(v)
	return _c
}

// SetNillablePlatform sets the "platform" field if the given value is not nil.
func (_c *CollectionCreate) SetNillablePlatform(v *collection.Platform) *CollectionCreate {
	if v != nil {
		_c.SetPlatform(*v)
	}
	return _c
...
func (_c *CollectionCreate) AddTaskIDs(ids ...uuid.UUID) *CollectionCreate {
	_c.mutation.AddTaskIDs(ids...)
	return _c
}

// AddTasks adds the "tasks" edges to the Task entity.
func (_c *CollectionCreate) AddTasks(v ...*Task) *CollectionCreate {
...
func (_c *CollectionCreate) check() error {
	...
	if _, ok := _c.mutation.Platform(); !ok {
		return &ValidationError{Name: "platform", err: errors.New(`ent: missing required field "Collection.platform"`)}
	}
