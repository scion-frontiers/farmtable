// Playwright verification script for farmtable web dashboard auth (deploy-36, Check c)
...
const EVIDENCE_DIR = '/scion-volumes/scratchpad/projects/farmtable/deploy/2026-07-23-deploy-36';
