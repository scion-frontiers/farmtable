...
let FtDashboardView = class FtDashboardView extends LitElement {
    connectedCallback() {
        super.connectedCallback();
        new TaskStoreController(this, this.store);
    }
    computePhaseStats(tasks) {
        const counts = {
            [TaskPhase.OPEN]: 0,
...
], FtDashboardView.prototype, "store", void 0);
FtDashboardView = __decorate([
    customElement('ft-dashboard-view')
], FtDashboardView);
export { FtDashboardView };
//# sourceMappingURL=ft-dashboard-view.js.map