...
import { TaskPhase, TaskPriority, RelationshipType, } from '../../gen/types.js';
...
import { STAGE_LABEL, STAGE_COLOR, } from '../inspector/inspector-stage-utils.js';
 ...
 */
let FtReadyQueueView = class FtReadyQueueView extends LitElement {
    constructor() {
        super(...arguments);
     ...
     */
    async scrollToSelectedRow() {
        await this.updateComplete;
        const row = this.renderRoot.querySelector('.queue-row.selected');
        if (row) {
    ...
    renderRow(task) {
      ...
      <div
        ...
        @keydown=${(e) => this.onRowKeyDown(e, task.id)}
      >
...
], FtReadyQueueView.prototype, "store", void 0);
__decorate([
    property({ attribute: 'selected-task-id' })
], FtReadyQueueView.prototype, "selectedTaskId", void 0);
__decorate([
    property({ attribute: false })
], FtReadyQueueView.prototype, "phaseFilter", void 0);
__decorate([
    property({ attribute: false })
], FtReadyQueueView.prototype, "assigneeFilter", void 0);
FtReadyQueueView = __decorate([
    customElement('ft-ready-queue-view')
], FtReadyQueueView);
export { FtReadyQueueView };
//# sourceMappingURL=ft-ready-queue-view.js.map